  ...
  return (
    <Fade>
      <section className="relative h-screen overflow-hidden">
        ...
        <section ref={ref} className="absolute  min-w-full min-h-screen flex flex-col justify-center items-center space-y-20 text-white text-center backdrop-blur-sm backdrop-opacity-95">
          <Fade delay={1500} >
